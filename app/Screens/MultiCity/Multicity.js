...
<TouchableOpacity onPress={swapContent3} style={{top:'47%', zIndex:1}}>
...
<Text style={styles.text}>
  Flight {count}
    ...
    <TextInput style={styles.textinputA} placeholder= 'From'
          value={input5}   onChangeText={text => setInput5(text)} />
    <TextInput style={styles.textinputB} placeholder= 'To'   
           value={input6}   onChangeText={text => setInput6(text)} />
...
<Text style={styles.book}>
 ...
 <View style={styles.box1}>
     <TouchableOpacity onPress={swapContent} style={{top:'47%', zIndex:1}}>
           <Image source={require('./../Assets/und.png')}  />  
    </TouchableOpacity>
              <Text style={styles.text}>Flight 1</Text>

              <TextInput style={styles.textinputA} placeholder= 'From'
          value={input1}   onChangeText={text => setInput1(text)} />
          <TextInput style={styles.textinputB} placeholder= 'To'   
           value={input2}   onChangeText={text => setInput2(text)} />

              <TextInput style={styles.textinputC} placeholder='Departure ' />
            </View>

          <View style={styles.box2}>
            <TouchableOpacity onPress={swapContent2} style={{top:'47%', zIndex:1}}>
               <Image source={require('./../Assets/und.png')}  />  
            </TouchableOpacity>
              ...
              <Text style={styles.text}>Flight 2</Text>
                ...
                <TextInput style={styles.textinputA} placeholder= 'From'
          value={input3}   onChangeText={text => setInput3(text)} />
          <TextInput style={styles.textinputB} placeholder= 'To'   
           value={input4}   onChangeText={text => setInput4(text)} />
