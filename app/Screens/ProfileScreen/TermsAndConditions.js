  ...
  return (
    <View style={styles.container}>
      <View style={styles.header}>
        <TouchableOpacity onPress={() => navigation.goBack(LegalInfo)}>
      ...
      <ScrollView contentContainerStyle={styles.contentContainer}>
        ...
        <Text style={styles.paragraph}>Upon termination, Your right to use the Service will cease immediately.</Text>
        ...
        <Text style={styles.paragraph}>
          ...
          so some or all of the above exclusions and limitations may not apply to You. But in such a case the exclusions and limitations set forth in this section shall be applied to the greatest extent enforceable under applicable law.
        </Text>
        ...
        <Text style={styles.paragraph}>
          Except as provided herein, the failure to exercise a right or to require performance of an obligation under these Terms shall not affect a party's ability to exercise such right 
          or require such performance at any time thereafter nor shall the waiver of a breach constitute a waiver of any subsequent breach.
        </Text>
        ...
        <Text style={styles.heading}>Changes to These Terms and Conditions</Text>
        <Text style={styles.paragraph}>
